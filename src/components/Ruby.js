...
import rubybig from "../assets/images/rubybig.jpg";
import rubysmall from "../assets/images/rubysmall.jpg";
import rubysmallback from "../assets/images/rubysmallback.jpg";
...
const Ruby = () => {
  return (
    ...
    <p className="text-white z-10 text-2xl flex items-center justify-center">5.0 <AiFillStar className="text-yellow-500 ml-3"/><AiFillStar className="text-yellow-500"/><AiFillStar className="text-yellow-500"/><AiFillStar className="text-yellow-500"/><AiFillStar className="text-yellow-500"/><AiFillStar className="text-yellow-500"/> </p>
    < NavLink to='/reviews' className=" text-gray z-10 underline"> Read Our 54 reviews </NavLink >
...
<section className="grid md:grid-cols-2 place-items-center px-2 md:px-6 py-10 gap-8">
   <div className="grid place-items-center">
       <img src={rubybig} alt="rubybig" className=""/>
       <div className="flex gap-4 justify-start">
           <img src={rubysmall} alt="rubysmall" />
           <img src={rubysmallback} alt="rubysmallback" />
       </div>
   </div>

   <div className="grid  ">
       <h4 className="text-colprm md:text-3xl text-2xl lg:text-4xl font-bold place-self-center md:place-self-start"> RUBY BLEND</h4>
...
<div className="py-10 grid place-items-center px-20 ">
   ...
   <div className="grid place-items-center place-self-start">
       ...
       < NavLink to='/nostalgia' className="text-colprm border-2 border-colprm  text-xl  font-bold center py-2 px-8 duration-500 hover:bg-colprm hover:text-white"> SELECT OPTION </NavLink >
   </div>
</div>
