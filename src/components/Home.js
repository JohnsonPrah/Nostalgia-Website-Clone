...
const Home = () => {
  ...
  return (
    <div className="bg-nostalgia-bg bg-cover bg-no-repeat bg-center-left">
        <div className="pt-[5rem] md:pt-[20vh] lg:pt-[52vh] pb-[5rem] md:pb-[3rem] lg:pb-40 bg-hero bg-cover bg-center grid place-items-center">
        ...
        <div className="grid md:grid-cols-2 bg-dep">
            ...
            <div className="relative pt-[12rem] order-2 md:order-none grid place-items-center md:pt-4 pb-16 px-10">
                <div className=" bg-colprm w-[2px] h-[4rem] hidden md:grid"></div>
                <img src={nosleft} alt="rubyright" className=" bottom-[55%] absolute md:static w-2/3 md:order-none md:w-[17rem] object-cover " />
                <h2 className="text-colprm my-1 text-3xl text-center font-bold"> NOSTALGIA BLEND </h2>
            ...
            <div className="order-4 relative pt-[12rem] md:order-none grid place-items-center md:pt-4 pb-16 px-10">
                <div className="bg-colprm w-[2px] h-[4rem] "></div>
                <img src={rubyright} alt="rubyright" className=" bottom-[55%] absolute md:static w-2/3 md:order-none md:w-[17rem] object-cover" />
                <h2 className="text-ruby my-1 text-3xl text-center font-bold"> RUBY BLEND </h2>
            ...
            <div className="order-6 md:order-none relative pt-[12rem] grid place-items-center md:pt-4 pb-16 px-10">
                <div className="bg-colprm w-[2px] h-[4rem] "></div>
                <img src={emeraldleft} alt="emeraldleft" className=" bottom-[55%] absolute md:static w-2/3 md:order-none md:w-[17rem] object-cover" />
                <h2 className="text-emerald my-1 text-3xl text-center font-bold"> EMERALD BLEND </h2>
